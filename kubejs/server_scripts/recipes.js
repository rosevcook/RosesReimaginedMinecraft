ServerEvents.recipes(event => {
  ...
  event.replaceInput({ output: 'minecraft:wooden_sword' }, '#minecraft:planks', 'minecraft:flint')
  ...
  event.shaped('minecraft:wooden_pickaxe', ['FFF', ' S ', ' T '], { F: 'minecraft:flint', S: 'farmersdelight:straw', T: 'minecraft:stick' })
