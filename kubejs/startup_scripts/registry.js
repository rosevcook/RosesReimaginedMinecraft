StartupEvents.registry('item', event => {
  event.create('silver_sheet').displayName('Silver Sheet').group('transportation')
  event.create('zinc_sheet').displayName('Zinc Sheet').group('transportation')
  event.create('lead_sheet').displayName('Lead Sheet').group('transportation')
  event.create('lead_dust').displayName('Lead Dust').group('transportation')
  event.create('rough_spinel').displayName('Rough Spinel').group('transportation')
  event.create('silver_feather').displayName('Silver Feather').group('transportation')
  event.create('copper_wire').displayName('Copper Wire').group('transportation')
  event.create('power_coil').displayName('Power Coil').group('transportation')
  event.create('torn_elytra_fragment').displayName('Torn Elytra Fragment').group('transportation')
  event.create('ice_rod').displayName('Ice Rod').parentModel('item/handheld').group('transportation')
  event.create('wadjet_tail').displayName('Wadjet Tail').rarity('uncommon').group('transportation')
  event.create('dry_moss').displayName('Dry Moss').group('transportation')
  event.create('anchor', 'pickaxe').tier('iron').attackDamageBaseline(6.5).speedBaseline(-3.0).group('combat')
  event.create('spinel_pickaxe', 'pickaxe').tier('iron').attackDamageBaseline(-2).speedBaseline(-2.5).group('tools')
  event.create('spinel_axe', 'axe').tier('iron').attackDamageBaseline(-2).speedBaseline(-2.5).group('tools')
  event.create('spinel_shovel', 'shovel').tier('iron').attackDamageBaseline(-2).speedBaseline(-2.5).group('tools')
})
